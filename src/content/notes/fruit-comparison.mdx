...
<IntroParagraph>Comparing values is one of those essential developer skills that helps you write **conditionals**, **if / then statements, filters**, and plenty more. Here's the apples and oranges guide to using them in JavaScript.</IntroParagraph>
