...
Intro: lay out the problem. Current agents have no memory or shitty memory. We're in the early days of figuring out how to make agents remember in the ways we expect them to; as humans would.
