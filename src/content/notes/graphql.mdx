...
<IntroParagraph>G[raphQL](https://graphql.org/) is undoubtedly one of the popular kids on the Web Development playground right now. If you haven't heard of GraphQL, the TLDR is that it's a new way to request data from an API. <Footnote idName={1}>If you're unsure what an API is, head on over to my illustrated article on [WTF is an API?](/api)</Footnote> One that's easier, faster, better, and stronger than the old [RESTful API system](https://en.wikipedia.org/wiki/Representational_state_transfer)</IntroParagraph>
...
<ImageLink href="https://egghead.io/courses/graphql-query-language">
  <RemoteImage
    ...
    src="https://og-image-egghead-course.vercel.app/graphql-query-language"
  />
</ImageLink>
