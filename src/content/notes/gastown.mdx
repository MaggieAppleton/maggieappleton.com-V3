...
I'm currently in the code-must-be-close camp, but rapidly shifting to the code-at-a-distance camp as I'm seeing the harnesses we wrap around these agents mature and ship with essential safe guards and quality gates. Sure, the models will also improve, but the infrastructure matters more: validation loops, tests, and specialised subagents who focus on security, debugging, and code quality are what will make code-at-a-distance feasible.

[BORING This all changes over the next 12 months. As models improve, trust will increase and tolerance for distance will grow. Backend and infrastructure work may shift dramatically toward distance. But some domains—UI/UX, creative coding, performance optimization—may remain proximity-dependent. New tools might bridge the gap: better visualization, semantic diffs, AI-assisted code review.]
