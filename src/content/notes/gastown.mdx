...
Here's the basic relationship structure of Gas Town:
...
Anyway, back to the point: this chain of command means stuck workers can ask for help instead of spinning their wheels and you only have to directly talk to one agent (the Mayor) instead of thirty. It's how human organisations scale, applied to agents.
