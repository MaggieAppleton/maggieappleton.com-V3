---
title: "Gas Town’s Agent Patterns, Design Bottlenecks, and Distant Code"
...
type: "note"
topics: ["Artificial Intelligence", "Design", "Language Models", "Web Development", "Critical Thinking"]
...
Gas Town's patchwork solution to this is aggressive prompting and constant nudging. Supervisor agents spend their time poking workers to see if anyone's stalled out or run dry on work. When one goes quiet, they send it a ping which jolts the agent into checking its queue and getting back to work. These periodic nudges move through the agent hierarchy like a heartbeat keeping everything moving. This is a decent bandaid for the first version, but more serious efforts at agent orchestration systems will need reliable ways to keep agents on task.
...
<BasicImage width="1000px" quality={100} framed src="/images/posts/gastown/conductor.webp" alt="Conductor's interface with agent chat as the primary interaction" showalt  />

<BasicImage width="1000px" quality={100} framed src="/images/posts/gastown/claude.webp" alt="Claude's Code's CLI interface with agent chat as the primary interaction" showalt  />
