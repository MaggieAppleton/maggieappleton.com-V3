...
I should be transparent and say that I have not used Gastown in earnest. I have only lighly poked at it, because I do not qualify as a serious user when I'm still hovering around levels 4-6 in Yegge's 8 levels of automation: juggling a handful of consecutive CLI agents, but still paying close attention to the diffs and regularly checking code in an IDE.

<BasicImage width="800px" src="/images/posts/gastown/stages.webp" alt="Yegge's eight levels of automation. Note: annotate and mark where I am" showalt sourceUrl="https://steve-yegge.medium.com/welcome-to-gas-town-4f25ee16dd04" sourceTitle="Welcome to Gastown" />

Gastown is a full-on stage 8 piece of tooling: using an orchestrator who manages dozens of other coding agents for you. Yegge also warned me not to seriously use Gastown multiple times, in increasingly threatening typography. I trust his guidance on his own slush pile.
