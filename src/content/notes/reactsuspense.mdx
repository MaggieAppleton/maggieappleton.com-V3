...
<IntroParagraph>Suspense is [an upcoming React feature](https://reactjs.org/docs/concurrent-mode-suspense.html) that's part of the new "concurrent mode." Since everyone is getting all hyped up about it, I wanted to figure out what the excitement was and drew some quick summary notes.</IntroParagraph>
...
<ImageLink href="https://egghead.io/courses/use-suspense-to-simplify-your-async-ui">
	<RemoteImage
		...
		src="https://og-image-egghead-course.vercel.app/use-suspense-to-simplify-your-async-ui"
		framed
	/>
</ImageLink>
...
<ImageLink href="https://egghead.io/courses/build-an-app-with-react-suspense">
	<RemoteImage
		width="800px"
		alt="Shareable Custom Hooks in React"
		src="https://og-image-egghead-course.vercel.app/build-an-app-with-react-suspense"
		framed
	/>
</ImageLink>
