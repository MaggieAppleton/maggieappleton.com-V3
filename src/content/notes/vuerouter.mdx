...
<IntroParagraph>I haven't explored the [Vue](https://vuejs.org/) framework much but it's got a thriving community, and I wanted to see how it compared to React, Svelte, and the 20 other font-end framework options.</IntroParagraph>
...
<ImageLink href="https://egghead.io/courses/a-journey-with-vue-router">
	<RemoteImage
		...
		src="https://og-image-egghead-course.vercel.app/a-journey-with-vue-router"
	/>
</ImageLink>
