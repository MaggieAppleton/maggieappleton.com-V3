...
topics: ["Anthropology", "The Web", "Artificial Intelligence", "Language Models", "Writing"]
growthStage: "budding"
featured: true
version: 2
updated: "2025-08-08"  # today's date
versionSummary: "Added new examples and updated conclusion"
---
...
<BasicImage
	...
	src="/images/posts/ai-dark-forest/cozyweb.jpg"
/>

That dark forest is about to <ExpandedText>expand</ExpandedText>. Large Language Models (LLMs) that can instantly generate coherent swaths of human-like text have just joined the party.
...
<GridColumns maxWidth="1100px">

<BasicImage src="/images/posts/ai-dark-forest/mj8.jpg" alt="..." />

<BasicImage src="/images/posts/ai-dark-forest/mj1.jpg" alt="..." />

<BasicImage src="/images/posts/ai-dark-forest/mj7.jpg" alt="..." />

<BasicImage src="/images/posts/ai-dark-forest/mj3.jpg" alt="..." />

<BasicImage src="/images/posts/ai-dark-forest/mj9.jpg" alt="..." />

<BasicImage src="/images/posts/ai-dark-forest/mj4.jpg" alt="..." />
...
They are a language model in a box. If a historical event, fact, person, or concept wasn't part of their training data, they can't tell you about it. They don't know about events that happened after a certain cutoff date. <Footnote idName={5}>Currently <YearsAgo>2021</YearsAgo> for GPT-3 / ChatGPT, but we can expect that to regularly update as new models are trained</Footnote>

I found Murray Shanahan's paper on [Talking About Large Language Models](http://arxiv.org/abs/2212.03551) <YearsAgo>(2022)</YearsAgo> full of helpful reflections on this point:
